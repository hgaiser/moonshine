...
fn bindgen_test_layout_CUDA_BATCH_MEM_OP_NODE_PARAMS_st() {
	const UNINIT: ::std::mem::MaybeUninit<CUDA_BATCH_MEM_OP_NODE_PARAMS_st> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
...
pub const CUdevice_attribute_enum_CU_DEVICE_ATTRIBUTE_MAX: CUdevice_attribute_enum = 133;
...
fn bindgen_test_layout_CUDA_MEM_ALLOC_NODE_PARAMS_st() {
	const UNINIT: ::std::mem::MaybeUninit<CUDA_MEM_ALLOC_NODE_PARAMS_st> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
